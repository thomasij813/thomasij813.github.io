...
The answer has less to do with what kind of lookups are forbidden and allowed by the JavaScript engine, and more with how that actual lookup process is performed. **I'll be honest and say that when I say scope is all about rules, I'm being a little misleading. In truth, it's more appropriate to think of scope in terms of a constrained route the engine takes when it's tasked with looking up variables.**
